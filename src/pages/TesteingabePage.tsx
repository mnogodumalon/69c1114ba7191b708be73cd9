...
export default function TesteingabePage() {
  ...
  return (
    <PageShell
      title="Testeingabe"
      subtitle={`${records.length} Testeingabe in the system`}
      action={
    ...
    >
      <div className="relative w-full max-w-sm">
        ...
        <Input
          placeholder="Search Testeingabe..."
          value={search}
            ...
            {filtered.length === 0 && (
              <TableRow>
                <TableCell colSpan={7} className="text-center py-16 text-muted-foreground">
                  {search ? 'No results found.' : 'No Testeingabe yet. Add one!'}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
