...
export function TesteingabeDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: TesteingabeDialogProps) {
  ...
  const DIALOG_INTENT = defaultValues ? 'Edit Testeingabe' : 'New Testeingabe';
