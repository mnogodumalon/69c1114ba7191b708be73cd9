...
import { IconArrowBackUp, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings, IconUsers, IconPlayerPlay, IconCode, IconTrash, IconChevronDown } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Kundenabrechnung', href: '/kundenabrechnung', icon: IconUsers },
  { name: 'Testeingabe', href: '/testeingabe', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Kundenabrechnung', href: '/gateway/apps/69c11fe6d96798d207f9c76b?template=list_page', icon: IconUsers },
  { name: 'Testeingabe', href: '/gateway/apps/69c1113a299eba5cd97468cd?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c11fe6d96798d207f9c76b?template=list_page"
