...
function WandIcon({ size = 20, className = '' }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 20 20" fill="none" className={className}>
      <path d="M3.33 16.67L12.5 7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10.83 5.83L14.17 9.17" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14.17 3.33L16.67 5.83L14.17 8.33L11.67 5.83L14.17 3.33Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M5 2.5V5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M3.75 3.75H6.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M15.83 13.33V15.83" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M14.58 14.58H17.08" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
    ...
    <div className="flex items-center gap-3 lg:gap-5">
      ...
      <div ref={appsRef} className="relative">
        ...
        {appsOpen && appGroups.length > 0 && (
          <div className="absolute right-0 top-full mt-2 w-[360px] bg-white rounded-[23px] shadow-[0px_8px_32px_0px_rgba(0,0,0,0.08)] p-5 z-50">
            {/* Header */}
            ...
            <div className="border-t border-border mt-4 pt-2">
              ...
              >
                <WandIcon size={20} className="text-[#374151] shrink-0" />
